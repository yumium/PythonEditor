        ...
        vex.open({
            ...
            afterOpen: function(vexContent) {
                ...
                var updateCompileVisibility = function () {
                    $('#compile').prop('disabled', $("#recordings").prop('childElementCount') < 0);
                };
						...
						tf.oneHot(data.map(x => x[1]), 2),
						{
							...
							callbacks: {
								...
								onTrainEnd: (logs) => {
									...
									// Get response and add to micropython
								}
							}
						}
					);
